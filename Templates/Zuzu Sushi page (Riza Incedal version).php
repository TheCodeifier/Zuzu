  ...
  <body>
    ...
    <form class="row g-3 needs-validation sushiForm"  action= "Zuzu%20Customer%20Details%20(Riza%20Incedal%20version).php" method= "POST">
        ...
        <img src= "/Images/NigiriSalmon.jpg" class= "position-relative formImage3">
            ...
            <div class="col-md-4 position-relative input3">
                <label for="validationCustom02" class="form-label"><?php echo $column3['name']; ?>&nbsp;<i>(20 pieces)</i></label>
                <input type="text" class="form-control" id="validationCustom02" required name= "nigiriSalmon" value= "0">
            </div>
