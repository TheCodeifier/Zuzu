...
<head>
    ...
    <link rel= "stylesheet" href= "/Project%20Zuzu/CSS%20Documents/Zuzu%20Customer%20overview%20Style%20(Riza%20Incedal%20version).css">
</head>
<body>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark navbar">
    <div class="container-fluid">
        ...
        <h2 class= "heading3 position-relative">Order summary</h2>

        <div class="card card3 position-relative">
            <div class="card-body">
                <h2>Order</h2>
