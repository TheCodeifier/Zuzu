<!--Zuzu Customer Details (Riza Incedal version)-->
<?php
session_start();
?>
    ...
    <body>
        ...
        <div class= "container">
            ...
            <div class="mb-3">
                <form class= "submissionForm position-relative" action= "/PHP%20Files/Zuzu%20Customer%20overview%20(Riza%20Incedal%20Version).php" method= "post">
                    ...
                    <div class="col-md-6 w-100 position-relative input9">
                        ...
                        <input type="text" class="form-control" id="validationCustom03" required name= "emailAdress">
                        <div class="valid-feedback">
                            Looks good!
                        </div>
                        <div class="invalid-feedback">
                            Please fill in your email adress.
                        </div>
                    </div>
            </div>
            ...
            <div class="col-md-6 w-100 position-relative input10">
                ...
                <input type="text" class="form-control" id="validationCustom03" required name= "deliveryAdress">
                <div class="valid-feedback">
                    Looks good!
                </div>
                <div class="invalid-feedback">
                    Please fill in your adress.
                </div>
            </div>

            <div class="col-md-3 w-100 position-relative input11">
                <label class="form-label">Postal code</label>
                <input type="text" class="form-control" id="validationCustom03" required name= "postalCode">
                <div class="valid-feedback">
                    Looks good!
                </div>
                <div class="invalid-feedback">
            ...
            <div class="col-md-3 w-100 position-relative input12">
                ...
                <input type="text" class="form-control" id="validationCustom05" required name= "residencePlace">
                <div class="valid-feedback">
                    Looks good!
                </div>
                <div class="invalid-feedback">
            ...
            <div class="col-12 w-100">
                <button type="submit" class="btn btn-dark button1" href= "/Project%20Zuzu/PHP%20Files/Zuzu%20Customer%20overview%20(Riza%20Incedal%20version).php">Submit</button>
            </div>
        </div>
        </form>
        ...
        <script src="/Javascript Documents/Zuzu form validation script.js" defer></script>
        </body> 